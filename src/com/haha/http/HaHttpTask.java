...
public abstract class HaHttpTask implements Runnable {
	...
	public HaHttpTask(String url, int maxRetryCount, HaHttpHandler handler)
			throws Exception {
	...
	public HaHttpTask(String hostPath, HaHttpParams params, int maxRetryCount,
			HaHttpHandler handler) throws Exception {
		this.request = new HaHttpRequest(hostPath, params);
		this.maxRetryCount = maxRetryCount;
		this.handler = handler;
	}
